...
BUILD_TARGETS = \
	...
	retrieval speculative infill tokenize benchmark-matmult parallel ibd_hx_extraction_parallel finetune export-lora lookahead lookup passkey gritlm tests/test-c.o
